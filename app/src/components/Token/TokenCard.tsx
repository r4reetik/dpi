...
const TokenCard = () => {
    return (
        <div>
            <div className={`flex flex-col items-center px-4 py-3 sm:flex-row bg-black-900 md:bg-black-800 rounded-xl`}>
                <div className='flex items-center self-start w-full gap-3 '>
                    ...
                    <button
            className='bg-black-700 p-[10px] rounded-full md:hidden'
            onClick={()=>{}}>
